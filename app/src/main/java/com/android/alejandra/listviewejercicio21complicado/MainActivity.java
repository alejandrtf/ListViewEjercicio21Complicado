...
public class MainActivity extends Activity {
    ...
    // declaro e inicializo a modo aóadir una variable para controlar el modo
    // del botón
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvLista.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view,
                ...
                // guardo la posición del elemento elegido para usarla despues
    ...
    protected void onSaveInstanceState(Bundle guardarEstado) {
        ...
        // guardo el array con los datos, la pos del ítem elegido y el
        // modo del botón
